...
def line_fit_pipeline(binary_img, source_img, detected, left_line, right_line):
    ...
    vehicle_offset = calc_vehicle_offset(source_img, left_fit, right_fit)
    combine_img = final_viz(source_img, left_fit, right_fit, Minv, left_curve, right_curve, vehicle_offset)
    avg_curve = (left_curve + right_curve) / 2

    return {'combined_img': combine_img,
            'birdeye_img': bird_fit_img,
            'lane_offset': vehicle_offset,
            'avg_curve': avg_curve,
            'detected': detected,
            'left_line': left_line,
